...
class GameRunner:
    ...
    def _sideboard(self, mainboard: dict, sideboard: dict,
        ...
        new_side = dict(sideboard)

        # Determine what's good/bad against the opponent
        ...
        # Determine cards to board out (weakest cards in the matchup)
        # Board out: slow cards vs aggro, dead removal vs combo, etc.
