...
class ComboReadiness:
    ...
    def can_probably_kill(self) -> bool:
        ...
        return self.has_payoff and self.potential_storm >= self.opponent_life
...
def decide_go_or_wait(readiness: ComboReadiness) -> ComboAction:
    ...
    if readiness.has_rebuy_engine and readiness.graveyard_rebuy_count >= 5 \
            and readiness.has_payoff:
        return ComboAction.GO_NOW

    # 8. Otherwise dig for more resources
