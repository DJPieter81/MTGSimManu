...
class GoalEngine:
    ...
    def _check_transitions(self, game: "GameState", player_idx: int,
        ...
        # DEPLOY_ENGINE: advance quickly if engine isn't found.
        # In real MTG, players don't wait 6 turns for an engine card.
        # They adapt their plan after 1-2 turns without it.
...
def get_gameplan(deck_name: str) -> Optional[DeckGameplan]:
    """Get the gameplan for a deck. Returns None if no plan is registered."""
