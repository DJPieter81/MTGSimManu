...
> **Last updated:** 2026-04-25 (Phase 2c combo refactor complete — `_combo_modifier` deleted, `card_combo_modifier` is the sole combo-scoring path, suite green, matrix N=20 within ±5pp)
