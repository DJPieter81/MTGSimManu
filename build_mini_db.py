#!/usr/bin/env python3
"""Build a minimal MTGJSON-format database for Domain Zoo + 4c Omnath cards.
Card data sourced from MTGJSON AtomicCards format."""
...
CARDS = {
    ...
    "Nishoba Brawler": [{
        ...
        "power": "*", "toughness": "3",
        "text": "Domain — Nishoba Brawler's power is equal to the number of basic land types among lands you control.\nTrample",
        "keywords": ["Domain", "Trample"],
        "colorIdentity": ["G"],
        "colors": ["G"],
    }],
    "Orcish Bowmasters": [{
    ...
    "Phlage, Titan of Fire's Fury": [{
        ...
        "power": "6", "toughness": "5",
        "text": "When this spell is cast and when Phlage, Titan of Fire's Fury enters the battlefield, it deals 3 damage to any target and you gain 3 life.\nEscape — {R}{R}{W}{W}, Exile five other cards from your graveyard.",
        "keywords": ["Escape"],
        "colorIdentity": ["R", "W"],
        "colors": ["R", "W"],
    }],
    ...
    "Endurance": [{
        ...
        "subtypes": ["Elemental", "Incarnation"],
        "power": "3", "toughness": "4",
        "text": "Flash\nReach\nWhen Endurance enters the battlefield, up to one target player shuffles their graveyard into their library.\nEvoke—Exile a green card from your hand.",
        "keywords": ["Flash", "Reach", "Evoke"],
        "colorIdentity": ["G"],
        "colors": ["G"],
    }],
    "Eternal Witness": [{
    ...
    "Quantum Riddler": [{
        ...
        "power": "3", "toughness": "4",
        "text": "When Quantum Riddler enters the battlefield, draw two cards.\nWhen Quantum Riddler dies, draw a card.",
        "keywords": [],
        "colorIdentity": ["U"],
        "colors": ["U"],
    }],
    ...
    "Galvanic Discharge": [{
        ...
        "manaValue": 1,
        "types": ["Sorcery"],
        "text": "Galvanic Discharge deals 2 damage to target creature or planeswalker. You get {E}{E}, then you may pay any amount of {E}. Galvanic Discharge deals that much additional damage to that permanent.",
        "keywords": [],
        "colorIdentity": ["R"],
        "colors": ["R"],
    }],
    ...
    "Arena of Glory": [{
        ...
        "manaValue": 0,
        "types": ["Land"],
        "text": "Arena of Glory enters the battlefield tapped.\n{T}: Add {R}.\n{T}, Exert Arena of Glory: Add {R}{R}. If you spend this mana to cast a creature spell, it gains haste until end of turn.",
        "keywords": [],
        "colorIdentity": ["R"],
        "colors": [],
    }],
...
db = {"data": CARDS}
with open("ModernAtomic_mini.json", "w") as f:
    json.dump(db, f, indent=1)

print(f"Wrote {len(CARDS)} cards to ModernAtomic_mini.json")
